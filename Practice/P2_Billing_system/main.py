...
class bill:
    ...
    #     print("\n")
    #     for i in range(len(self.Quantity_of_selected_fruits)):
    #         print(self.Quantity_of_selected_fruits[i])
    ...
    def Buy_fruit(self):
        ...
        while(True):
            ...
            if choice == 1:
                ...
                Qnt = int(input("Enter the Quantity number you want : "))
                self.bill += (int(self.fruits[i]["pineapple"]) * Qnt)
                ...
                Qnt = int(input("Enter the Quantity number you want : "))
                self.bill += (int(self.fruits[i]["cherry"]) * Qnt)
                ...
                Qnt = int(input("Enter the Quantity number you want : "))
                self.bill += (int(self.fruits[i]["kiwi"]) * Qnt)
                ...
                Qnt = int(input("Enter the Quantity number you want : "))
                self.bill += (int(self.fruits[i]["mango"]) * Qnt)
                ...
                Qnt = int(input("Enter the Quantity number you want : "))
                self.bill += (int(self.fruits[i]["Grapes"]) * Qnt)
        ...
        if self.is_available == True:
            ...
            for i in range (len(list(self.Quantity_of_selected_fruits))):
                ...
                if r_item == "e" or r_item == "E":
                    ...
                    value = list(self.value_of_seleceted_fruit[r_item-1].values())[0]
                    self.bill -= value
